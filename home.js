...
const zipCode1 = 85205;
const deliveryStatus = canWeDeliverTwo(zipCode1);
...
//CODE HERE
let replacedDeal = deals[0].title.replace('15', '10')
...
let newFamDeal = deals[1].desc.trim().replace('March', 'April')